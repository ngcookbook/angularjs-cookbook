angular.module('cookbookApp', [])
   .controller('MainController', function($scope) {
        ...
        $scope.selectAllTasks = function() {
            angular.forEach($scope.tasks, function(task) { task.completed = true; });
        };

        $scope.deselectAllTasks = function() {
            angular.forEach($scope.tasks, function(task) { task.completed = false; });
        };

        $scope.invertAllTasks = function() {
            angular.forEach($scope.tasks, function(task) { task.completed = !task.completed; });
        };
